...
/**
 * Property definition aliases
 * type less for common tasks
 *
 * @function `oop.hidden`
 * defines a non-enumerable, non-writable, data descriptor
 *
 * @function `oop.visible`
 * defines a enumerable, non-writable, data descriptor
 *
 */

oop.hidden = function ( o, pname, value ) {
  Object.defineProperty( o, pname, { value: value } );
}
oop.visible = function ( o, pname, value ) {
  Object.defineProperty( o, pname, { value: value, enumerable: true } );
};
...
// TODO multiple chain (oop.createChain)
...
/**
 * Utility for creating simple factory functions for any prototype
 */
...
/**
 * Returns a constructor created with oop.constructor
 * whose prototype is set to given prototype (or an empty 
 * object if none given).
 *
 * Esentially, this function does the following:
 *
 *    var MyConstructor = oop.constructor();
 ...
 * with a message about abstraction, if it's called
 */
